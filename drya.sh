...
function f_drya_get_all_repo_names_private_public {
   ...
   # Juntar a lista de repos publicas + privadas 
      ...
      v_list_private="dv-cv-private moedaz omni-log luxam scratch-paper upK-diario-Dv wikiD 3-sticks-alpha-bravo verbose-lines one-file-bau dandarez dWiki Tesoro dial-mono yoga-bash-app-private autoPay Dv-Indratena Subeat"
